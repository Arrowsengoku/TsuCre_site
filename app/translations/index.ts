export const translations = {
  ja: {
    ...
    home: {
      ...
      features: {
        ...
        items: [
          {
            title: '自分好みにカスタマイズ可能',
            description: 'ボタンやスティック、外装を自由に交換でき、プレイスタイルや好みに合わせて選択可能。',
          },
          {
            title: '簡単にパーツ交換ができる',
            description: '独自の内部構造により、特殊な工具なしで簡単にパーツ交換が可能。',
          },
          {
            title: '低コストで長く使える',
            description: '破損しても交換パーツを購入すればよいため、通常のコントローラーより長期間使用可能。',
          },
        ],
      },
      testimonials: {
    ...
    about: {
      title: '私たちについて',
      intro: {
        text1: 'TsuCre(ツクレ)は京都大学と東北大学の大学院生が立ち上げたデバイスメーカーです。',
        text2: 'ソフトウェア領域では個別最適化が進んでいる一方、ハードウェア領域では実現していません。',
        text3: '私たちはまず、使用者ごとのニーズが大きく異なるゲーミングデバイス分野に挑戦します。',
      },
      vision: {
        title: 'Vision',
  ...
  en: {
    ...
    about: {
      ...
      intro: {
        ...
        text2: 'While software is personalized, hardware remains generic.',
        text3: 'We aim to revolutionize gaming devices, where user needs vary significantly.',
      },
      vision: {
        title: 'Vision',
      ...
      credo: {
        title: 'Credo',
        items: [
          { title: 'Create what you want', description: 'Build what you truly desire.' },
          { title: 'Be crazy', description: 'Break norms and act boldly.' },
          { title: 'Done is better than perfect', description: 'Action over perfection.' },
        ],
      },
      team: {
        title: 'Our Team',
